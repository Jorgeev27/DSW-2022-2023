<?php
    ...
    class BasePDO{
         ...
         * @param string dbname - Nombre de la base de datos a la que desea conectarse.
         * @param string driver - Tipo de base de datos a la que te estás conectando.
         * @param string user - Nombre de usuario para conectarse a la base de datos.
         * @param string pass - Contraseña para el usuario de la base de datos.
         * @return PDO - Objeto PDO.
         */
        public static function getConexion(string $dbname, string $driver, string $user = null, $pass = null): PDO{
            try{
                $dsn = "";
                if($driver == "mysql"){
